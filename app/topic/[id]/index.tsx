...
export default function TopicFeedScreen() {
  ...
  // Auto-generate flag - only trigger once per mount
  ...
  // Auto-generate memos if none exist (for newly created topics)
  useEffect(() => {
    if (!isLoading && memos.length === 0 && topic && !hasAutoGenerated.current && !isGenerating) {
      hasAutoGenerated.current = true;
      handleGenerateMore();
    }
  }, [isLoading, memos.length, topic, isGenerating]);
        ...
        {hasMore ? (
          ...
          <View style={styles.emptyState}>
            {isGenerating ? (
              <>
                <ActivityIndicator size="large" color="#c4dfc4" />
                <Text style={styles.emptyTitle}>Creating memos...</Text>
                <Text style={styles.emptySubtitle}>This may take a moment</Text>
              </>
            ) : (
              <>
